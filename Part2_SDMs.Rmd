...
```{r globalscriptPart2, eval = FALSE, cache = FALSE}
...
```{r globalscriptHiddenPart2, include = FALSE, cache = FALSE}
...
```{r simulationPkgsHidden, include = FALSE, cache = FALSE}
...
knitr::include_graphics(normalizePath("outputs/generalFigures/MaxEntPredictions.tiff", winslash = "/"))
```
