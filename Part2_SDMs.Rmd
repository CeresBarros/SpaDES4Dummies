...
Require::Require(c(unname(unlist(outs)),
                   ...
                   "PredictiveEcology/SpaDES.tools@master (HEAD)"), 
                 require = FALSE,   ## don't load packages
                 upgrade = FALSE,   ## don't upgrade dependencies
                 dependencies = TRUE,  ## get all dependencies
...
Require::Require(c("SpaDES.core", "SpaDES.experiment"), install = FALSE) ## now load packages
...
knitr::include_graphics(normalizePath("figures/Part2_objectDiagram.png", winslash = "/"))
```
