...
```{r loadPkgs, message = FALSE, warning = FALSE, cache = FALSE}
...
```{r globalscriptHiddenPart1, include = FALSE, cache = FALSE}
rm(list = ls())
...
knitr::include_graphics(normalizePath("obj.png", winslash = "/"))
```
...
knitr::include_graphics(normalizePath("simul_plot.png", winslash = "/"))
```
