...
```{r loadPkgs, message = FALSE, warning = FALSE, results = 'hide', class.source = "fold-show"}
...
```{r moduleDiagram, echo = -1, fig.height=6, fig.width=6, message=FALSE, warning=FALSE, fig.cap="Diagram of module connections."}
moduleDiagram(mySim)
```
