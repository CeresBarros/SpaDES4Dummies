...
```{r loadPkgs, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r globalscriptPart1, message = FALSE, warning = FALSE}
...
```{r moduleDiagram, echo = -1, fig.height=10, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Diagram of module connections."}
clearPlot()
moduleDiagram(mySim)
```
...
```{r objectDiagram, echo = FALSE, fig.align = 'center', fig.cap = "Module diagram showing module inter-dependencies with object names.", fig.width = 7}
