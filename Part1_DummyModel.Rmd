...
```{r globalscriptHiddenPart1, eval = FALSE}
rm(list = ls())
...
knitr::include_graphics(normalizePath("figures/obj.png", winslash = "/"))
```
...
knitr::include_graphics(normalizePath("figures/Part1_objectDiagram.png", winslash = "/"))
```
...
knitr::include_graphics(normalizePath("figures/simul_plot.png", winslash = "/"))
```
