...
test_dir("C:/Ceres/OneDrive/GitHub/SpaDES4Dummies/m/speciesTempLM/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ceres/OneDrive/GitHub/SpaDES4Dummies/m/speciesTempLM/tests/testthat/test-template.R")
