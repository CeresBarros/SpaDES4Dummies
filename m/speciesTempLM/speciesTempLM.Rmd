...
moduleDir <- file.path("C:/Ceres/OneDrive/GitHub/SpaDES4Dummies/m")
...
If `sourceURL` is specified, `downloadData("speciesTempLM", "path/to/modules/dir")` may be sufficient.
