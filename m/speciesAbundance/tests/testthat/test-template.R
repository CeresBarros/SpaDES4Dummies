...
# 2. Copy this file to the tests folder (i.e., `C:/Ceres/GitHub/SpaDES4Dummies/m/speciesAbundance/tests/testthat`).
...
test_that("test Event1 and Event2.", {
  ...
  path <- list(modulePath = "C:/Ceres/GitHub/SpaDES4Dummies/m",
