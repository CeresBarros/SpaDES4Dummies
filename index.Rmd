...
``` {r zenodoBadgePrep, echo = FALSE, eval = TRUE, cache = FALSE}
...
badgePath <- normalizePath("figures/zenodoBadge.svg")

rsvgImage <- rsvg::rsvg(badgePath)
png::writePNG(rsvgImage, "figures/zenodoBadge.png", dpi = 144)
badgePath <- normalizePath("figures/zenodoBadge.png")
```

# Preface {-}

``` {r zenodoBadge, echo = FALSE, eval = TRUE, cache = FALSE, results = "asis"}
