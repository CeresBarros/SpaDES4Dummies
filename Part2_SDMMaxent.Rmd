...
```{r figSimulationSppAbund, echo = FALSE, fig.align = 'center', out.width = "50%", fig.show='hold', fig.cap = "**Simulation plots**: Input *Picea glauca* percent cover across the landscape - note that values are converted to presence/absence."}
