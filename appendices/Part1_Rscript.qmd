...
if (!dir.exists(file.path(projPath, "modules", "speciesAbundance"))) {
  newModule(name = "speciesAbundance", path = file.path(projPath, "modules"))
}

if (!dir.exists(file.path(projPath, "temperature"))) {
  newModule(name = "temperature", path = file.path(projPath, "modules"))
}

if (!dir.exists(file.path(projPath, "speciesTempLM"))) {
  newModule(name = "speciesTempLM", path = file.path(projPath, "modules"))
}
