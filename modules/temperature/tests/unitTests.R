...
test_dir("D:/GitHub/SpaDES4Dummies/modules/temperature/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("D:/GitHub/SpaDES4Dummies/modules/temperature/tests/testthat/test-template.R")
