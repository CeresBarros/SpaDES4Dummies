...
test_dir("C:/Ceres/GitHub/SpaDES4Dummies/modules/speciesAbundance/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ceres/GitHub/SpaDES4Dummies/modules/speciesAbundance/tests/testthat/test-template.R")
