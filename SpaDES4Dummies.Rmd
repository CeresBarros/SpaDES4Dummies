...
description: "A beginner's guide to `SpaDES`"
---
...
[Part 1](https://htmlpreview.github.io/?https://github.com/CeresBarros/SpaDES4Dummies/blob/master/Example1_DummyModel.html) is very minimal, and uses only dummy data. It is meant to introduce you to the different components of a `SpaDES` module.
[Part 2](https://htmlpreview.github.io/?https://github.com/CeresBarros/SpaDES4Dummies/blob/master/Example2_SDMMaxent.html) uses real and freely available data, and provides a deeper look into several useful aspects of `SpaDES`, notably caching and spatial data processing.
...
Last updated: 
```{r DatePart1, include=FALSE}
Sys.Date()
```

```{r setupPart1, include=FALSE}
...
```{r stats_module, code = readLines(file.path("modules", "speciesTempLM", "R",  "linear_model_functions.R")), eval = FALSE}
```
...
Last updated: 
```{r DatePart2, include=FALSE}
Sys.Date()
```

```{r setupPart2, include=FALSE}
options("repos" = c(CRAN = "https://cran.rstudio.com"))
knitr::opts_chunk$set(cache = 2, cache.rebuild = FALSE)
```

In [Part 1](https://htmlpreview.github.io/?https://github.com/CeresBarros/SpaDES4Dummies/blob/master/Example1_DummyModel.html) of this guide, we described how to create new `SpaDES` modules, their different components, how to link different modules and how to set up and run a simulation.
...
We assume you are already familiar with the different parts of a module `.R` script; if not, see [Part 1](https://htmlpreview.github.io/?https://github.com/CeresBarros/SpaDES4Dummies/blob/master/Example1_DummyModel.html).
