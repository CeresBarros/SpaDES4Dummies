...
Now go ahead and open the *speciesAbundance.R* script. I know, I know... It seems confusing and there's a lot of stuff in that template! 

The first thing you need to know is that **you don't need to run** any of the code inside a module *.R* script. The function `simInit` will do it for you when it sets up the simulation (you'll see this later). But before that, let's go throught the module *.R* script together.
